...
class DefaultApi(object):
    ...
    def get_management_model(self, id, **kwargs):  # noqa: E501
        """Gets the specified base model.  # noqa: E501

        Gets the specified base model.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_management_model(id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str id: Format - uuid. (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_management_model_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_management_model_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def get_management_model_with_http_info(self, id, **kwargs):  # noqa: E501
        """Gets the specified base model.  # noqa: E501

        Gets the specified base model.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_management_model_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_management_model" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `get_management_model`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/management/v3.0/models/{id}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='ManagementModel',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_management_models(self, **kwargs):  # noqa: E501
        """Gets a list of all base models.  # noqa: E501

        Gets a list of all base models.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_management_models(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_management_models_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_management_models_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_management_models_with_http_info(self, **kwargs):  # noqa: E501
        """Gets a list of all base models.  # noqa: E501

        Gets a list of all base models.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_management_models_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_management_models" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/management/v3.0/models', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='ManagementModelArray',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
