...
class Transcription(object):
    ...
    def __init__(self, links=None, properties=None, _self=None, model=None, project=None, dataset=None, content_urls=None, content_container_url=None, display_name=None, description=None, custom_properties=None, locale=None, last_action_date_time=None, status=None, created_date_time=None):  # noqa: E501
    ...
    def content_container_url(self):
        ...
        A URL for an Azure blob container that contains the audio files. A container is allowed to have a maximum size of 5GB and a maximum number of 10000 blobs.  The maximum size for a blob is 2.5GB.  This property will not be returned in a response.  # noqa: E501
