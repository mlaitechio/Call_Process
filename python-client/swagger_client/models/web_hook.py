...
class WebHook(object):
    ...
    def __init__(self, links=None, properties=None, _self=None, display_name=None, description=None, web_url=None, events=None, created_date_time=None, last_action_date_time=None, status=None, custom_properties=None):  # noqa: E501
