...
class TranscriptionProperties(object):
    ...
    def __init__(self, diarization_enabled=None, word_level_timestamps_enabled=None, duration=None, channels=None, destination_container_url=None, punctuation_mode=None, profanity_filter_mode=None, time_to_live=None, email=None, error=None):  # noqa: E501
    ...
    def punctuation_mode(self, punctuation_mode):
        ...
        if punctuation_mode not in allowed_values:
            raise ValueError(
    ...
    def profanity_filter_mode(self, profanity_filter_mode):
        ...
        if profanity_filter_mode not in allowed_values:
            raise ValueError(
