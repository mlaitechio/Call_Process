...
class ManagementModelProperties(object):
    ...
    def __init__(self, purposes=None, model_class=None, vad_kind=None, uses_online_interpolation=None, cascade_delete=None, is_dynamic_grammar_supported=None, uses_halide=None):  # noqa: E501
    ...
    def model_class(self, model_class):
        ...
        if model_class not in allowed_values:
            raise ValueError(
    ...
    def vad_kind(self, vad_kind):
        ...
        if vad_kind not in allowed_values:
            raise ValueError(
