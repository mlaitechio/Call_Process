...
class Model(object):
    ...
    def __init__(self, project=None, links=None, properties=None, _self=None, display_name=None, description=None, text=None, base_model=None, datasets=None, locale=None, last_action_date_time=None, status=None, created_date_time=None, custom_properties=None):  # noqa: E501
